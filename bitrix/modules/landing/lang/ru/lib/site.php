...
$MESS['LANDING_TYPE_SMN'] = 'Проект';
$MESS['LANDING_TYPE_KNOWLEDGE'] = 'База знаний';
$MESS['LANDING_TYPE_GROUP'] = 'Группы';
$MESS['LANDING_TYPE_MAINPAGE'] = 'Главная страница';
$MESS['LANDING_EXPORT_ERROR'] = 'Параметр code может состоять только из латинских букв и цифр.';
...
$MESS['LANDING_UPDATE_FOLDER_ERROR_INDEX_OUT_OF_SITE'] = 'Главная страница папки должна быть страницей этого же сайта.';
