...
(function (exports, landing_ui_panel_content, main_core_events, landing_ui_button_basebutton, landing_loc, main_core, landing_ui_field_presetfield, landing_pageobject, landing_ui_button_sidebarbutton, ui_fonts_opensans, ui_designTokens, ui_textcrop, main_loader, landing_ui_card_headercard, landing_ui_card_messagecard, landing_ui_form_formsettingsform, landing_collection_basecollection, landing_ui_form_baseform) {
	'use strict';

	var _templateObject$3, _templateObject2$2;
	function ownKeys$2(e, r) { var t = Object.keys(e); if (Object.getOwnPropertySymbols) { var o = Object.getOwnPropertySymbols(e); r && (o = o.filter(function (r) { return Object.getOwnPropertyDescriptor(e, r).enumerable; })), t.push.apply(t, o); } return t; }
	function _objectSpread$2(e) { for (var r = 1; r < arguments.length; r++) { var t = null != arguments[r] ? arguments[r] : {}; r % 2 ? ownKeys$2(Object(t), true).forEach(function (r) { babelHelpers.defineProperty(e, r, t[r]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t)) : ownKeys$2(Object(t)).forEach(function (r) { Object.defineProperty(e, r, Object.getOwnPropertyDescriptor(t, r)); }); } return e; }
	var PresetCategory = /*#__PURE__*/function () {
		...
		return babelHelpers.createClass(PresetCategory, [{
			key: "setPresets",
	...
	var _templateObject$2, _templateObject2$1, _templateObject3$1, _templateObject4, _templateObject5;
	function ownKeys$1(e, r) { var t = Object.keys(e); if (Object.getOwnPropertySymbols) { var o = Object.getOwnPropertySymbols(e); r && (o = o.filter(function (r) { return Object.getOwnPropertyDescriptor(e, r).enumerable; })), t.push.apply(t, o); } return t; }
	function _objectSpread$1(e) { for (var r = 1; r < arguments.length; r++) { var t = null != arguments[r] ? arguments[r] : {}; r % 2 ? ownKeys$1(Object(t), true).forEach(function (r) { babelHelpers.defineProperty(e, r, t[r]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t)) : ownKeys$1(Object(t)).forEach(function (r) { Object.defineProperty(e, r, Object.getOwnPropertyDescriptor(t, r)); }); } return e; }
	function _callSuper$2(t, o, e) { return o = babelHelpers.getPrototypeOf(o), babelHelpers.possibleConstructorReturn(t, o.apply(t, e) || t); }
	...
	var Preset = /*#__PURE__*/function (_EventEmitter) {
		function Preset(options) {
			...
			_this = _callSuper$2(this, Preset, [options]);
		...
		return babelHelpers.createClass(Preset, [{
			key: "getTextCrop",
	...
	function _callSuper$1(t, o, e) { return o = babelHelpers.getPrototypeOf(o), babelHelpers.possibleConstructorReturn(t, o.apply(t, e) || t); }
	// Patched after build: super() initialises the given `this`; legacy heirs steal these constructors via .apply().
	var ContentWrapper = /*#__PURE__*/function (_EventEmitter) {
		function ContentWrapper(options) {
			...
			_this = _callSuper$1(this, ContentWrapper);
		...
		return babelHelpers.createClass(ContentWrapper, [{
			key: "addItem",
			...
			value: function getLayout() {
				return this.cache.remember('wrapper', function () {
					return main_core.Tag.render(_templateObject$1 || (_templateObject$1 = babelHelpers.taggedTemplateLiteral(["<div class=\"landing-ui-panel-form-settings-content-wrapper\"></div>"])));
				});
			}
		}, {
			key: "getValue",
			value: function getValue() {
				var value = this.items.reduce(function (acc, item) {
					if (item instanceof landing_ui_form_baseform.BaseForm && item.getLayout().parentElement) {
						return _objectSpread(_objectSpread({}, acc), item.serialize());
					}
					return acc;
				}, {});
	...
	var BasePresetPanel = /*#__PURE__*/function (_Content) {
		function BasePresetPanel() {
			...
			_this = _callSuper(this, BasePresetPanel);
			...
			_this.cache = new main_core.Cache.MemoryCache();
			_this.onSidebarButtonClick = _this.onSidebarButtonClick.bind(_this);
			_this.onSaveClick = _this.onSaveClick.bind(_this);
			_this.onCancelClick = _this.onCancelClick.bind(_this);
			_this.onPresetFieldClick = _this.onPresetFieldClick.bind(_this);
			_this.onPresetClick = _this.onPresetClick.bind(_this);
			_this.onChange = _this.onChange.bind(_this);
		...
		return babelHelpers.createClass(BasePresetPanel, [{
			...
			value: function appendSidebarButton(button) {
				_superPropGet(BasePresetPanel, "appendSidebarButton", this, 3)([button]);
			}
			...
			value: function getRightHeaderControls() {
				return this.cache.remember('rightHeaderControls', function () {
					return main_core.Tag.render(_templateObject2 || (_templateObject2 = babelHelpers.taggedTemplateLiteral(["<div class=\"landing-ui-panel-base-preset-header-controls-right\"></div>"])));
				});
			}
		}, {
			...
			value: function show(options) {
				...
				return _superPropGet(BasePresetPanel, "show", this, 3)([options]).then(function () {
			...
			value: function hide() {
				...
				return _superPropGet(BasePresetPanel, "hide", this, 3)([]).then(function () {
					if (_this0.isToggleModeEnabled()) {
			...
			value: function setPresets(presets) {
				...
				presets.forEach(function (preset) {
					preset.unsubscribe('onClick', _this1.onPresetClick);
					preset.subscribe('onClick', _this1.onPresetClick);
				});
			...
			value: function onPresetFieldClick() {
				...
				this.getCategories().forEach(function (category) {
					...
					_this11.getPresets().forEach(function (preset) {
...
})(this.BX.Landing.UI.Panel = this.BX.Landing.UI.Panel || {}, BX.Landing.UI.Panel, BX.Event, BX.Landing.UI.Button, BX.Landing, BX, BX.Landing.UI.Field, BX.Landing, BX.Landing.UI.Button, BX, window, BX.UI, BX, BX.Landing.UI.Card, BX.Landing.UI.Card, BX.Landing.UI.Form, BX.Landing.Collection, BX.Landing.UI.Form);
