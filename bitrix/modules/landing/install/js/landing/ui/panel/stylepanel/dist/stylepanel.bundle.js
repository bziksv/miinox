...
(function (exports, main_core, main_loader, landing_ui_panel_content, landing_loc, landing_pageobject) {
	...
	var StylePanel = /*#__PURE__*/function (_Content) {
		function StylePanel() {
			...
			_this = _callSuper(this, StylePanel, [options]);
			babelHelpers.defineProperty(_this, "shouldAdjustTopPanelControls", false);
		...
		return babelHelpers.createClass(StylePanel, [{
			key: "getSwitcher",
			...
			value: function show(formMode) {
				...
				return _superPropGet(StylePanel, "show", this, 3)([]).then(function () {
			...
			value: function hide() {
				...
				return _superPropGet(StylePanel, "hide", this, 3)([]).then(function () {
					StylePanel[enableEditorPointerEvents]();
					main_core.Dom.addClass(document.body, 'landing-ui-collapsed');
