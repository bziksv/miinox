...
(function (exports, main_core, main_core_events) {
   ...
   */
  var BaseButton = /*#__PURE__*/function (_main_core_events$Eve) {
    function BaseButton(id, options) {
      ...
      if (main_core.Type.isStringFilled(_this.options.ariaLabel)) {
        _this.setAriaLabel(_this.options.ariaLabel);
      }
    ...
    babelHelpers.inherits(BaseButton, _main_core_events$Eve);
    return babelHelpers.createClass(BaseButton, [{
      ...
      value: function getLayout() {
        ...
        return this.cache.remember('layout', function () {
          ...
          if (_this2.options.toggle) {
            layout.setAttribute('aria-pressed', _this2.options.active ? 'true' : 'false');
          }
          return layout;
        });
      }
      ...
      value: function setAriaLabel(text) {
        main_core.Dom.attr(this.layout, 'aria-label', text);
      }
    }, {
      key: "disable",
      value: function disable() {
        main_core.Dom.addClass(this.layout, 'landing-ui-disabled');
        main_core.Dom.attr(this.layout, 'disabled', '');
      }
    }, {
      key: "enable",
      ...
      value: function activate() {
        ...
        if (this.options.toggle) {
          main_core.Dom.attr(this.layout, 'aria-pressed', 'true');
        }
      }
    }, {
      key: "deactivate",
      value: function deactivate() {
        ...
        if (this.options.toggle) {
          main_core.Dom.attr(this.layout, 'aria-pressed', 'false');
        }
      }
    }, {
      key: "isActive",
...
})(this.BX.Landing.UI.Button = this.BX.Landing.UI.Button || {}, BX, BX.Event);
