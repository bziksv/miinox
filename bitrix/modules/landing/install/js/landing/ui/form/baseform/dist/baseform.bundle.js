...
(function (exports, ui_designTokens, ui_fonts_opensans, main_core, main_core_events, landing_loc, landing_env) {
	'use strict';
	...
	var BaseForm = /*#__PURE__*/function (_EventEmitter) {
		...
		return babelHelpers.createClass(BaseForm, [{
			key: "show",
			value: function show() {
			...
			value: function getHeaderCheckbox() {
				...
				return this.cache.remember('headerCheckbox', function () {
					...
					if (main_core.Type.isString(help) && help !== '') {
						...
						main_core.Dom.attr(helpButton, 'aria-label', landing_loc.Loc.getMessage('LANDING_UI_FORM_BASEFORM_HEADER_HELP_LABEL'));
...
})(this.BX.Landing.UI.Form = this.BX.Landing.UI.Form || {}, window, BX, BX, BX.Event, BX.Landing, BX.Landing);
