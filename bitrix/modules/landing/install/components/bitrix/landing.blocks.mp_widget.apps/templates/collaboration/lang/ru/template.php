...
$MESS['BLOCK_MP_WIDGET_APPS_COLLABORATION_DESKTOP_TEXT'] = 'Установите приложение';
$MESS['BLOCK_MP_WIDGET_APPS_COLLABORATION_QR_POPUP_TITLE'] = 'Вход в мобильное приложение Битрикс24';
$MESS['BLOCK_MP_WIDGET_APPS_COLLABORATION_QR_POPUP_TEXT_1'] = 'Используйте ваш персональный QR-код для быстрого перехода и мгновенной авторизации с телефона.';
$MESS['BLOCK_MP_WIDGET_APPS_COLLABORATION_QR_POPUP_TEXT_2'] = '<b>Никому не показывайте этот код.</b> В нем содержится информация для входа под вашим именем.';
