...
$MESS["MAIL_CLIENT_CONFIG_DIRS_OUTCOME_SAVE"] = "Отправленные письма сохранять в папке:";
$MESS["MAIL_CLIENT_CONFIG_DIRS_TRASH_SAVE"] = "Удаленные письма перемещать в папку:";
$MESS["MAIL_CLIENT_CONFIG_DIRS_SPAM_SAVE"] = "Спам перемещать в папку:";

$MESS["MAIL_CLIENT_CONFIG_DIRS_NOT_SPECIFIED"] = "не указано";

$MESS["MAIL_CLIENT_CONFIG_DIRS_BTN_SAVE"] = "Сохранить";
$MESS["MAIL_CLIENT_CONFIG_DIRS_BTN_CANCEL"] = "Отменить";
