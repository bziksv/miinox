...
$MESS["MAIL_CLIENT_CONFIG_SMTP_SERVER_2"] = "Адрес SMTP-сервера";
...
$MESS["MAIL_CLIENT_CONFIG_OWNER"] = "Владелец ящика";
$MESS["MAIL_CLIENT_CONFIG_OWNER_CHANGE"] = "Изменить";
...
$MESS["MAIL_CLIENT_CONFIG_SMTP_PASS_BAD"] = "Пароль не может начинаться с символа \"^\" и не должен содержать нулевых байтов";
...
$MESS["MAIL_CLIENT_CONFIG_IMAP_AUTH_ERR_OAUTH"] = "Не прошла авторизация на внешнем сервере входящей почты. Убедитесь, что пользователь с этим e-mail подключен к внешнему почтовому серверу. Если почтовым аккаунтом управляет администратор вашей компании, обратитесь к нему для настройки.";
$MESS["MAIL_CLIENT_CONFIG_IMAP_AUTH_ERR_OAUTH_SMTP"] = "Не прошла авторизация на внешнем сервере исходящей почты. Убедитесь, что на почтовом сервере настроена отправка писем по протоколу SMTP или снимите галку \"Отправлять через внешний SMTP\". Если почтовым аккаунтом управляет администратор вашей компании, обратитесь к нему для настройки.";
...
$MESS['MAIL_CLIENT_CONFIG_TOOLBAR_SIGNATURES'] = 'Подписи';
