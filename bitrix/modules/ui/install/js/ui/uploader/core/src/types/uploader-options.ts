...
import { type ResizeImageMode, type ResizeImageMimeType, type ResizeImageMimeTypeMode, type ResizeImageOptions } from '../types/resize-image-options';
...
export type UploaderOptions = {
	...
	filters?: Array<{
		type: FilterType;
		filter: Filter | (new (...args: any[]) => Filter) | string;
