...
if (!empty($message['__files'])):
	...
	<div class="mail-msg-view-file-inner">
		...
		<?php endforeach ?>
		<button type="button" id="mail_msg_<?=$message['ID'] ?>_refresh_files_button" class="mail-msg-view-file-item mail-msg-refresh-files-button">
			<span class="mail-msg-refresh-files-button-icon" aria-hidden="true"></span>
