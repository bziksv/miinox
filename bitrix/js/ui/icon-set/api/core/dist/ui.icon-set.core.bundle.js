...
(function (exports, main_core) {
	...
	class Icon {
		...
		constructor(params) {
			...
			this.size = params.size !== undefined && params.size > 0 ? params.size : null;
		...
		render() {
			...
			this.iconElement = main_core.Tag.render`<div class="${className}"></div>`;
			if (this.#responsive) {
		...
		setHoverMode(hoverMode) {
			...
			main_core.Dom.removeClass(this.iconElement, this.#getHoverModeClassnameModifier(prevHoverMode));
			main_core.Dom.addClass(this.iconElement, this.#getHoverModeClassnameModifier(hoverMode));
		}
		...
		#getHoverModeClassnameModifier(hoverMode) {
			const hoverModeModifiers = {
				[IconHoverMode.DEFAULT]: '--hoverable-default',
				[IconHoverMode.ALT]: '--hoverable-alt'
			};
			return (hoverMode !== null ? hoverModeModifiers[hoverMode] : '') ?? '';
		}
		#checkIconExistence(iconName) {
