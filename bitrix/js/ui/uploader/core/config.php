...
return [
	...
	'settings' => [
		...
		'parallelChunkUpload' => Configuration::isParallelChunkUploadEnabled(),
		'maxParallelChunks' => Configuration::getMaxParallelChunks(),
		'presignedChunkUpload' => Configuration::isPresignedChunkUploadEnabled(),
		'presignedThreshold' => Configuration::getPresignedThreshold(),
		'presignedRegisterInterval' => Configuration::getPresignedRegisterInterval(),
