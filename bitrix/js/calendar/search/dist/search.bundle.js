...
(function (exports, calendar_util, main_core_events, main_core, main_popup) {
	...
	class Search {
		...
		getEmptyResultPopupContent() {
			return main_core.Tag.render`<div class="calendar-search-no-result-popup-container">
			<div class="calendar-search-no-result-popup-title">${main_core.Loc.getMessage('EC_CALENDAR_EMPTY_SEARCH_RESULT_TITLE')}</div>
			<div class="calendar-search-no-result-popup-text">${main_core.Loc.getMessage('EC_CALENDAR_EMPTY_SEARCH_RESULT_TEXT')}</div>
		</div>`;
		}
		isFilterEmpty() {
