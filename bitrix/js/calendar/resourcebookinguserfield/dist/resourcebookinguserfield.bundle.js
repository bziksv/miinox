/* eslint-disable */
this.BX = this.BX || {};
(function (exports, calendar_resourcebooking, calendar_resourcebookinguserfield, main_popup, main_core, ui_entitySelector, main_core_events) {
	'use strict';
	...
	class UserSelectorFieldTunner extends FormFieldTunnerAbstract {
		...
		buildValuePopup(params) {
			...
			this.DOM.valueWrap.appendChild(main_core.Tag.render`
				<div class="calendar-resbook-webform-settings-popup-select-result">
					${this.DOM.usersValueLink = main_core.Tag.render`
						<span 
...
})(this.BX.Calendar = this.BX.Calendar || {}, BX.Calendar, BX.Calendar, BX.Main, BX, BX.UI.EntitySelector, BX.Event);
