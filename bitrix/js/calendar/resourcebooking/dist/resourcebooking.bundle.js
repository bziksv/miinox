/* eslint-disable */
this.BX = this.BX || {};
(function (exports, main_core, main_popup, main_date, main_core_events) {
	'use strict';
	...
	class ViewControlAbstract {
		...
		display() {
			...
			this.DOM.dataWrap = this.DOM.wrap.appendChild(main_core.Tag.render`<div data-bx-resource-data-wrap="Y"></div>`);
			if (this.isDisplayed()) {
				this.show({
					animation: false
				});
	...
	class DateSelector extends ViewControlAbstract {
		...
		display(params) {
			...
			this.DOM.wrap = this.DOM.outerWrap.appendChild(main_core.Tag.render`<div class="calendar-resbook-webform-block"></div>`);
			this.DOM.innerWrap = this.DOM.wrap.appendChild(main_core.Tag.render`<div class="calendar-resbook-webform-block-inner"></div>`);
			if (this.data.label) {
				this.DOM.labelWrap = this.DOM.innerWrap.appendChild(main_core.Dom.create("div", {
					props: {
		...
		displayControl() {
			this.DOM.controlWrap = this.DOM.innerWrap.appendChild(main_core.Tag.render`<div class="calendar-resbook-webform-block-date"></div>`);
			if (this.style === 'popup') {
	...
	class PopupDateSelector {
		...
		build() {
			...
			this.DOM.valueInput = this.DOM.wrap.appendChild(main_core.Tag.render`<input type="hidden" 
value=""/>`);
			this.DOM.previousArrow = this.DOM.wrap.appendChild(main_core.Tag.render`<span class="calendar-resbook-webform-block-strip-arrow calendar-resbook-webform-block-strip-arrow-prev" data-bx-resbook-date-meta="previous"/>`);
			this.DOM.stateWrap = this.DOM.wrap.appendChild(main_core.Tag.render`<span class="calendar-resbook-webform-block-strip-text" data-bx-resbook-date-meta="calendar"/>`);
			this.DOM.stateWrapDate = this.DOM.stateWrap.appendChild(main_core.Tag.render`<span class="calendar-resbook-webform-block-strip-date"/>`);
			this.DOM.stateWrapDay = this.DOM.stateWrap.appendChild(main_core.Tag.render`<span class="calendar-resbook-webform-block-strip-day"/>`);
			this.DOM.nextArrow = this.DOM.wrap.appendChild(main_core.Tag.render`<span class="calendar-resbook-webform-block-strip-arrow calendar-resbook-webform-block-strip-arrow-next" data-bx-resbook-date-meta="next"/>`);
		}
		getValue() {
			return this.value;
		}
		setValue(dateValue) {
			...
			main_core.Dom.adjust(this.DOM.stateWrapDate, {
				text: BookingUtil.formatDate(main_core.Loc.getMessage('WEBF_RES_DATE_FORMAT_DATE_LINE'), dateValue)
			});
			main_core.Dom.adjust(this.DOM.stateWrapDay, {
				text: BookingUtil.formatDate(main_core.Loc.getMessage('WEBF_RES_DATE_FORMAT_DAY_LINE'), dateValue)
			});
	...
	class LineDateSelector {
		...
		build() {
			...
			this.DOM.controlStaticWrap = this.DOM.wrap.appendChild(main_core.Tag.render`<div class="calendar-resbook-webform-block-date-range-static-wrap" 
></div>`);
			this.DOM.controlInnerWrap = this.DOM.controlStaticWrap.appendChild(main_core.Tag.render`<div class="calendar-resbook-webform-block-date-range-inner-wrap" 
></div>`);
			this.DOM.valueInput = this.DOM.wrap.appendChild(main_core.Tag.render`<input type="hidden" 
value=""/>`);
			this.fillDays();
		...
		addDateSlot(date) {
			...
			this.DOM.dayNodes[dateCode] = this.DOM.controlInnerWrap.appendChild(main_core.Dom.create("div", {
				...
				html: '<div class="calendar-resbook-webform-block-date-item-inner">' + '<span class="calendar-resbook-webform-block-date-number">' + BookingUtil.formatDate(main_core.Loc.getMessage('WEBF_RES_DATE_FORMAT_DATE'), date) + '</span>' + '<span class="calendar-resbook-webform-block-date-day">' + BookingUtil.formatDate(main_core.Loc.getMessage('WEBF_RES_DATE_FORMAT_DAY_OF_THE_WEEK'), date) + '</span>' + '</div>'
			}));
		}
		...
		initCustomScroll() {
			let arrowWrap = this.DOM.wrap.appendChild(main_core.Tag.render`<div class="calendar-resbook-webform-block-arrow-container" 
></div>`);
	...
	class TimeSelector extends ViewControlAbstract {
		...
		display() {
			...
			if (this.data.label) {
				...
				if (this.timezone) {
					this.DOM.timezoneLabelWrap = this.DOM.labelWrap.appendChild(main_core.Tag.render`<div class="calendar-resbook-webform-block-title-timezone"></div>`);
		...
		showEmptyWarning() {
			...
			if (!this.DOM.warningWrap) {
				this.DOM.warningTextNode = main_core.Tag.render`<span class="calendar-resbook-webform-block-notice-date"/>`;
				this.DOM.warningWrap = this.DOM.innerWrap.appendChild(main_core.Dom.create("div", {
					...
					children: [main_core.Tag.render`<span class="calendar-resbook-webform-block-notice-icon"/>`, this.DOM.warningTextNode, main_core.Dom.create("span", {
						props: {
			...
			if (this.DOM.warningWrap) {
				main_core.Dom.adjust(this.DOM.warningTextNode, {
					text: BookingUtil.formatDate(main_core.Loc.getMessage('WEBF_RES_BUSY_DAY_DATE_FORMAT'), this.currentDate)
				});
		...
		createSlotsControl() {
			...
			this.DOM.controlStaticWrap = this.DOM.controlWrap.appendChild(main_core.Tag.render`<div class="calendar-resbook-webform-block-time-static-wrap"></div>`);
			this.DOM.controlInnerWrap = this.DOM.controlStaticWrap.appendChild(main_core.Tag.render`<div class="calendar-resbook-webform-block-time-inner-wrap"></div>`);
			let itemsInColumn,
				maxColumnNumber = 3,
				parts = {},
				itemNumber = 0,
			...
			this.slots.forEach(function (slot) {
				if (!parts[slot.partOfTheDay].wrap) {
					...
					parts[slot.partOfTheDay].itemsWrap = parts[slot.partOfTheDay].wrap.appendChild(main_core.Tag.render`<div class="calendar-resbook-webform-block-col-list"></div>`);
				...
				if (itemNumber % itemsInColumn === 0) {
					innerWrap = parts[slot.partOfTheDay].itemsWrap.appendChild(main_core.Tag.render`<div class="calendar-resbook-webform-block-col-list-inner"></div>`);
				}
		...
		initCustomScrollForSlots() {
			let arrowWrap = this.DOM.controlWrap.appendChild(main_core.Tag.render`<div class="calendar-resbook-webform-block-arrow-container" />`);
			this.DOM.leftArrow = arrowWrap.appendChild(main_core.Dom.create("span", {
				props: {
					className: 'calendar-resbook-webform-block-arrow calendar-resbook-webform-block-arrow-prev'
				},
	...
	class StatusInformer {
		...
		build() {
			this.DOM.wrap = this.DOM.outerWrap.appendChild(main_core.Tag.render`<div class="calendar-resbook-webform-block-result" style="display: none" 
></div>`);
			this.DOM.innerWrap = this.DOM.wrap.appendChild(main_core.Tag.render`<div class="calendar-resbook-webform-block-result-inner"></div>`);
			...
			this.DOM.statusWrap = this.DOM.innerWrap.appendChild(main_core.Tag.render`<div class="calendar-resbook-webform-block-result-value"></div>`);
		...
		getStatusText(params) {
			...
			if (params.fullDay) {
				if (BookingUtil.formatDate('Y-m-d', dateFrom.getTime() / 1000) === BookingUtil.formatDate('Y-m-d', dateTo.getTime() / 1000)) {
					text = BookingUtil.formatDate(main_core.Loc.getMessage('WEBF_RES_DATE_FORMAT_STATUS'), dateFrom);
				} else {
					text = main_core.Loc.getMessage('WEBF_RES_DATE_FORMAT_FROM_TO').replace('#DATE_FROM#', BookingUtil.formatDate(main_core.Loc.getMessage('WEBF_RES_DATE_FORMAT_STATUS_SHORT'), dateFrom)).replace('#DATE_TO#', BookingUtil.formatDate(main_core.Loc.getMessage('WEBF_RES_DATE_FORMAT_STATUS_SHORT'), dateTo));
				}
			} else {
				if (BookingUtil.formatDate('Y-m-d', dateFrom.getTime() / 1000) === BookingUtil.formatDate('Y-m-d', dateTo.getTime() / 1000)) {
					text = BookingUtil.formatDate(main_core.Loc.getMessage('WEBF_RES_DATE_FORMAT_STATUS'), dateFrom) + ' ' + main_core.Loc.getMessage('WEBF_RES_TIME_FORMAT_FROM_TO').replace('#TIME_FROM#', BookingUtil.formatTime(dateFrom.getHours(), dateFrom.getMinutes())).replace('#TIME_TO#', BookingUtil.formatTime(dateTo.getHours(), dateTo.getMinutes()));
				} else {
					text = main_core.Loc.getMessage('WEBF_RES_DATE_FORMAT_FROM_TO').replace('#DATE_FROM#', BookingUtil.formatDate(main_core.Loc.getMessage('WEBF_RES_DATE_FORMAT_STATUS_SHORT'), dateFrom) + ' ' + BookingUtil.formatTime(dateFrom.getHours(), dateFrom.getMinutes())).replace('#DATE_TO#', BookingUtil.formatDate(main_core.Loc.getMessage('WEBF_RES_DATE_FORMAT_STATUS_SHORT'), dateTo) + ' ' + BookingUtil.formatTime(dateTo.getHours(), dateTo.getMinutes()));
				}
			}
			return text;
		}
	...
	class LiveFieldController extends main_core_events.EventEmitter {
		...
		init() {
			...
			this.DOM.outerWrap = this.DOM.wrap.appendChild(main_core.Tag.render`<div class="calendar-resbook-webform-wrapper"></div>`);
			this.showMainLoader();
		...
		buildFormControls() {
			this.DOM.innerWrap = this.DOM.outerWrap.appendChild(main_core.Tag.render`<div class="calendar-resbook-webform-inner"></div>`);
			this.DOM.inputsWrap = this.DOM.innerWrap.appendChild(main_core.Tag.render`<div></div>`);
		...
		onChangeValues() {
			...
			if (main_core.Type.isDate(dateFrom) && !this.statusControl.isErrorSet()) {
				...
				entries.forEach(function (entry) {
					...
					this.DOM.valueInputs.push(this.DOM.inputsWrap.appendChild(main_core.Tag.render`
					<input 
		...
		showMainLoader() {
			if (this.DOM.wrap) {
				this.hideMainLoader();
				let loaderWrap = main_core.Tag.render`<div class="calendar-resbook-webform-wrapper-loader-wrap"></div>`;
		...
		setLoadedDataLimits(from, to) {
			this.loadedDataFrom = main_core.Type.isDate(from) ? from : BookingUtil.parseDate(from);
			this.loadedDataTo = main_core.Type.isDate(to) ? to : BookingUtil.parseDate(to);
		...
		getFreeEntitiesForDate(date, params) {
			this.getSettingsData();
				let slotsAmount = params.slotsAmount || 1,
				i,
				userList,
				resList;
		...
		checkSlotsForDate(date, slotsAmount, params) {
			let userIsFree = true,
				resourcesAreFree = true,
				dateKey = main_core.Type.isDate(date) ? BookingUtil.formatDate(this.DATE_FORMAT, date) : date;
			params = params || {};
	...
	class BookingUtil {
		...
		static getDateFormat() {
			if (main_core.Type.isNull(BookingUtil.DATE_FORMAT)) {
				BookingUtil.DATE_FORMAT = CoreDate.convertBitrixFormat(main_core.Loc.getMessage("FORMAT_DATE"));
			}
			return BookingUtil.DATE_FORMAT;
		}
		static getDateTimeFormat() {
			if (main_core.Type.isNull(BookingUtil.DATETIME_FORMAT)) {
				BookingUtil.DATETIME_FORMAT = CoreDate.convertBitrixFormat(main_core.Loc.getMessage("FORMAT_DATETIME"));
			}
			return BookingUtil.DATETIME_FORMAT;
		}
		static getTimeFormat() {
			if (main_core.Type.isNull(BookingUtil.TIME_FORMAT)) {
		...
		static getTimeFormatShort() {
			if (main_core.Type.isNull(BookingUtil.TIME_FORMAT_SHORT)) {
...
`;
		...
		static getSimpleTimeList() {
			if (main_core.Type.isNull(BookingUtil.simpleTimeList)) {
				let i,
					res = [];
				for (i = 0; i < 24; i++) {
					res.push({
		...
		static adaptTimeValue(timeValue) {
			...
			let timeList = BookingUtil.getSimpleTimeList(),
				diff = 24 * 60,
				ind = false,
				i;
	...
	class SelectInput extends main_core.Event.EventEmitter {
		constructor(params) {
			super(params);
		...
		showPopup() {
			...
			BookingUtil.bindCustomEvent(this.popupMenu.popupWindow, 'onPopupClose', function () {
				this.shown = false;
			}.bind(this));
			this.input.select();
