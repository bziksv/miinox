...
`}static fireCustomEvent(e,s,i,a){if(window.BX&&t.Type.isFunction(BX.onCustomEvent)){return BX.onCustomEvent(e,s,i,a)}}static bindCustomEvent(e,s,i){if(window.BX&&t.Type.isFunction(BX.addCustomEvent)){return BX.addCustomEvent(e,s,i)}}static unbindCustomEvent(e,s,i){if(window.BX&&t.Type.isFunction(BX.removeCustomEvent)){return BX.removeCustomEvent(e,s,i)}}static isAmPmMode(){return w.isAmPmMode()}static mergeEx(){let e=Array.prototype.slice.call(arguments);if(e.length<2){return{}}let s=e.shift();for(let i=0;i<e.length;i++){for(let a in e[i]){if(typeof e[i]==="undefined"||e[i]==null||!e[i].hasOwnProperty(a)){continue}if(t.Type.isPlainObject(e[i][a])&&t.Type.isPlainObject(s[a])){g.mergeEx(s[a],e[i][a])}else{s[a]=t.Type.isPlainObject(e[i][a])?t.Runtime.clone(e[i][a]):e[i][a]}}}return s}static getDurationList(e){let t=[5,10,15,20,25,30,40,45,50,60,90,120,180,240,300,360,1440,1440*2,1440*3,1440*4,1440*5,1440*6,1440*7,1440*10],s,i,a=[];for(i=0;i<t.length;i++){s=t[i];if(e&&s%1440!==0){continue}a.push({value:s,label:g.getDurationLabel(s)})}return a}static getDurationLabel(e){let s;if(e%1440===0){s=t.Loc.getMessage("USER_TYPE_DURATION_X_DAY").replace("#NUM#",e/1440)}else if(e%60===0&&e!==60){s=t.Loc.getMessage("USER_TYPE_DURATION_X_HOUR").replace("#NUM#",e/60)}else{s=t.Loc.getMessage("USER_TYPE_DURATION_X_MIN").replace("#NUM#",e)}return s}static parseDuration(e){let s=e,i=parseInt(e),a=false,r=new RegExp("(\\d)\\s*("+t.Loc.getMessage("USER_TYPE_DURATION_REGEXP_DAY")+").*","ig"),l=new RegExp("(\\d)\\s*("+t.Loc.getMessage("USER_TYPE_DURATION_REGEXP_HOUR")+").*","ig");e=e.replace(r,(function(e,t){a=true;return t}));if(a){e=i*1440}else{e=s.replace(l,(function(e,t){a=true;return t}));if(a){e=i*60}else{e=i}}return parseInt(e)||0}static getSimpleTimeList(){if(t.Type.isNull(g.simpleTimeList)){let e,t=[];for(e=0;e<24;e++){t.push({value:e*60,label:this.formatTime(e,0)});t.push({value:e*60+30,label:this.formatTime(e,30)})}g.simpleTimeList=t}return g.simpleTimeList}static adaptTimeValue(e){e=parseInt(e.h*60)+parseInt(e.m);let t=g.getSimpleTimeList(),s=24*60,i=false,a;for(a=0;a<t.length;a++){if(Math.abs(t[a].value-e)<s){s=Math.abs(t[a].value-e);i=a;if(s<=15){break}}}return t[i||0]}static getDayLength(){return g.DAY_LENGTH}static showLimitationPopup(){if(top.BX.getClass("BX.UI.InfoHelper")){top.BX.UI.InfoHelper.show("limit_crm_booking")}}}class M extends t.Event.EventEmitter{constructor(e){super(e);this.settings=e.settings||{};this.showTitle=e.displayTitle!==false;this.title=e.title||"";this.DOM={wrap:e.wrap}}build(){this.controls={};this.DOM.outerWrap=this.DOM.wrap.appendChild(t.Dom.create("div",{props:{className:"calendar-resbook-webform-wrapper calendar-resbook-webform-wrapper-form"}}));this.DOM.innerWrap=this.DOM.outerWrap.appendChild(t.Dom.create("div",{props:{className:"calendar-resbook-webform-inner"}}));if(this.settings.userfieldSettings.useUsers||this.settings.userfieldSettings.useResources){this.displayTitle();this.displayUsersControl();this.displayResourcesControl();this.displayServicesControl();this.displayDurationControl();this.displayDateControl();this.displayTimeControl()}else{this.displayWarning(t.Loc.getMessage("WEBF_RES_BOOKING_WARNING"))}}destroy(){t.Dom.remove(this.DOM.outerWrap)}displayTitle(){if(this.showTitle){this.DOM.titleWrap=this.DOM.innerWrap.appendChild(t.Dom.create("div",{props:{className:"calendar-resbook-webform-title"}})).appendChild(t.Dom.create("div",{props:{className:"calendar-resbook-webform-title-text"}}));this.updateTitle(this.title)}}updateTitle(e){if(this.showTitle){this.title=e;t.Dom.adjust(this.DOM.titleWrap,{text:this.title})}}displayWarning(e){this.DOM.warningWrap=this.DOM.innerWrap.appendChild(t.Dom.create("div",{props:{className:"ui-alert ui-alert-warning ui-alert-text-center ui-alert-icon-warning"},style:{marginBottom:0},html:'<span class="ui-alert-message">'+e+"</span>"}))}displayUsersControl(){if(this.settings.userfieldSettings.useUsers){if(this.settings.data.users.value===null&&t.Type.isArray(this.settings.userfieldSettings.users)){this.settings.data.users.value=this.settings.userfieldSettings.users}this.controls.users=new o({outerWrap:this.DOM.innerWrap,data:this.settings.data.users,userIndex:this.settings.userfieldSettings.userIndex});this.controls.users.display()}}displayResourcesControl(){if(this.settings.userfieldSettings.useResources){if(this.settings.data.resources.value===null&&t.Type.isArray(this.settings.userfieldSettings.resources)){this.settings.data.resources.value=[];this.settings.userfieldSettings.resources.forEach((function(e){this.settings.data.resources.value.push(parseInt(e.id))}),this)}this.controls.resources=new n({outerWrap:this.DOM.innerWrap,data:this.settings.data.resources,resourceList:this.settings.userfieldSettings.resources});this.controls.resources.display()}}displayServicesControl(){if(this.settings.userfieldSettings.useServices){if(this.settings.data.services.value===null&&t.Type.isArray(this.settings.userfieldSettings.services)){this.settings.data.services.value=[];this.settings.userfieldSettings.services.forEach((function(e){this.settings.data.services.value.push(e.name)}),this)}this.controls.services=new h({outerWrap:this.DOM.innerWrap,data:this.settings.data.services,serviceList:this.settings.userfieldSettings.services});this.controls.services.display()}}displayDurationControl(){if(!this.settings.userfieldSettings.useServices){this.controls.duration=new d({outerWrap:this.DOM.innerWrap,data:this.settings.data.duration,fullDay:this.settings.userfieldSettings.fullDay});this.controls.duration.display()}}displayDateControl(){this.controls.date=new u({outerWrap:this.DOM.innerWrap,data:this.settings.data.date});this.controls.date.display()}displayTimeControl(){if(!this.settings.userfieldSettings.fullDay){this.controls.time=new f({outerWrap:this.DOM.innerWrap,data:this.settings.data.time});this.controls.time.display()}}refreshLayout(e){for(let s in this.controls){if(this.controls.hasOwnProperty(s)&&t.Type.isFunction(this.controls[s].refresh)){this.controls[s].refresh(e[s]||this.settings.data[s])}}}getInnerWrap(){return this.DOM.innerWrap}getOuterWrap(){return this.DOM.outerWrap}}class C extends M{constructor(e){super(e)}}class S extends M{constructor(e){super(e)}build(){super.build();this.DOM.outerWrap.className="calendar-resbook-webform-wrapper calendar-resbook-webform-wrapper-preview calendar-resbook-webform-wrapper-dark"}}class T extends t.Event.EventEmitter{constructor(e){super(e);this.id=e.id||"bx-select-input-"+Math.round(Math.random()*1e6);if(t.Type.isFunction(e.getValues)){this.getValues=e.getValues;this.values=this.getValues()}else{this.values=e.values||false}this.input=e.input;this.defaultValue=e.defaultValue||"";this.openTitle=e.openTitle||"";this.className=e.className||"";this.currentValue=e.value;this.currentValueIndex=e.valueIndex;this.onChangeCallback=t.Type.isFunction(e.onChangeCallback)?e.onChangeCallback:null;this.onAfterMenuOpen=e.onAfterMenuOpen||null;this.zIndex=e.zIndex||1200;this.disabled=e.disabled;this.editable=e.editable!==false;this.setFirstIfNotFound=!!e.setFirstIfNotFound;if(this.onChangeCallback){t.Event.bind(this.input,"change",this.onChangeCallback);t.Event.bind(this.input,"keyup",this.onChangeCallback)}this.curInd=false;if(t.Type.isArray(this.values)){t.Event.bind(this.input,"click",this.onClick.bind(this));if(this.editable){t.Event.bind(this.input,"focus",this.onFocus.bind(this));t.Event.bind(this.input,"blur",this.onBlur.bind(this));t.Event.bind(this.input,"keyup",this.onKeyup.bind(this))}else{t.Event.bind(this.input,"focus",function(){this.input.blur()}.bind(this))}if(this.currentValueIndex===undefined&&this.currentValue!==undefined){this.currentValueIndex=-1;for(let e=0;e<this.values.length;e++){if(parseInt(this.values[e].value)===parseInt(this.currentValue)){this.currentValueIndex=e;break}}if(this.currentValueIndex===-1){this.currentValueIndex=this.setFirstIfNotFound?0:undefined}}}if(this.currentValueIndex!==undefined&&this.values[this.currentValueIndex]){this.input.value=this.values[this.currentValueIndex].label}}showPopup(){if(this.getValues){this.values=this.getValues()}if(this.shown||this.disabled||!this.values.length){return}let e=0,i=0,a=[],r,l=this;for(r=0;r<this.values.length;r++){if(this.values[r].delimiter){a.push(this.values[r])}else{if(this.currentValue&&this.values[r]&&this.values[r].value===this.currentValue.value||this.input.value===this.values[r].label){e=i}a.push({id:this.values[r].value+"_"+r,text:this.values[r].label,onclick:this.values[r].callback||function(e,t){return function(){l.input.value=t;l.popupMenu.close();l.onChange(e,t)}}(this.values[r].value,this.values[r].labelRaw||this.values[r].label)});i++}}this.popupMenu=s.MenuManager.create(this.id,this.input,a,{closeByEsc:true,autoHide:true,zIndex:this.zIndex,offsetTop:0,offsetLeft:0,cacheable:false});if(!BX.browser.IsFirefox()){this.popupMenu.popupWindow.setMinWidth(this.input.offsetWidth)}this.popupMenu.popupWindow.setMaxWidth(300);let o=this.popupMenu.getPopupWindow().getContentContainer();t.Dom.addClass(this.popupMenu.layout.menuContainer,"calendar-resourcebook-select-popup");this.popupMenu.show();let n=this.popupMenu.menuItems[e];if(n&&n.layout){o.scrollTop=n.layout.item.offsetTop-2}g.bindCustomEvent(this.popupMenu.popupWindow,"onPopupClose",function(){this.shown=false}.bind(this));this.input.select();if(t.Type.isFunction(this.onAfterMenuOpen)){this.onAfterMenuOpen(e,this.popupMenu)}this.shown=true}closePopup(){s.MenuManager.destroy(this.id);this.shown=false}onFocus(){setTimeout(function(){if(!this.shown){this.showPopup()}}.bind(this),200)}onClick(){if(this.shown){this.closePopup()}else{this.showPopup()}}onBlur(){setTimeout(this.closePopup.bind(this),200)}onKeyup(){setTimeout(this.closePopup.bind(this),50)}onChange(e){let s=this.input.value;this.emit("BX.Calendar.Resourcebooking.SelectInput:changed",new t.Event.BaseEvent({data:{selectinput:this,value:s,realValue:e}}));if(this.onChangeCallback){this.onChangeCallback({value:s,realValue:e})}}destroy(){if(this.onChangeCallback){t.Event.unbind(this.input,"change",this.onChangeCallback);t.Event.unbind(this.input,"keyup",this.onChangeCallback)}t.Event.unbind(this.input,"click",this.onClick.bind(this));t.Event.unbind(this.input,"focus",this.onFocus.bind(this));t.Event.unbind(this.input,"blur",this.onBlur.bind(this));t.Event.unbind(this.input,"keyup",this.onKeyup.bind(this));if(this.popupMenu){this.popupMenu.close()}s.MenuManager.destroy(this.id);this.shown=false}setValue(e){this.input.value=e;if(t.Type.isArray(this.values)){let t=-1;for(let s=0;s<this.values.length;s++){if(this.values[s].value===e){t=s;break}}if(t!==-1){this.input.value=this.values[t].label;this.currentValueIndex=t}}}getValue(){return this.input.value}}let w=window.BX&&BX.Main&&BX.Main.Date?BX.Main.Date:null;class O{static getLiveField(e){if(!e.wrap||!t.Type.isDomNode(e.wrap)){throw new Error('The argument "params.wrap" must be a DOM node')}if(t.Type.isNull(w)){throw new Error("The error occured during Date extention loading")}let s=new D(e);s.init();return s}static getPreviewField(e){}}e.Browser=t.Browser;e.Dom=t.Dom;e.Event=t.Event;e.Loc=t.Loc;e.Runtime=t.Runtime;e.Tag=t.Tag;e.Text=t.Text;e.Type=t.Type;e.MenuManager=s.MenuManager;e.PopupManager=s.PopupManager;e.BaseEvent=a.BaseEvent;e.EventEmitter=a.EventEmitter;e.BookingUtil=g;e.CoreDate=w;e.FieldViewControllerEdit=C;e.FieldViewControllerPreview=S;e.Resourcebooking=O;e.SelectInput=T})(this.BX.Calendar=this.BX.Calendar||{},BX,BX.Main,BX.Main,BX.Event);
