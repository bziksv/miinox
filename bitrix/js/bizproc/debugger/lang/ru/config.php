...
$MESS['BIZPROC_DEBUGGER_AUTOMATION_POPUP_TITLE'] = 'Отладчик роботов';
$MESS['BIZPROC_DEBUGGER_AUTOMATION_ROBOTS_TITLE'] = 'Роботы';
$MESS['BIZPROC_DEBUGGER_AUTOMATION_TRIGGERS_TITLE'] = 'Триггеры';
$MESS['BIZPROC_DEBUGGER_AUTOMATION_LOG_TITLE'] = 'Лог';
$MESS['BIZPROC_DEBUGGER_AUTOMATION_DOCUMENT_TITLE'] = 'Поля';
$MESS['BIZPROC_DEBUGGER_AUTOMATION_ACTION_START'] = 'Запустить отладку';
...
$MESS['BIZPROC_JS_DEBUGGER_LOG_TRIGGER_TITLE'] = 'Триггер "#TITLE#"';
$MESS['BIZPROC_JS_DEBUGGER_LOG_FINISH_WITHOUT_SETTINGS'] = 'Отсутствует дополнительная информация';
$MESS['BIZPROC_JS_DEBUGGER_LOG_DELAY_INTERVAL_RUN'] = 'Выполняется';
$MESS['BIZPROC_JS_DEBUGGER_LOG_AFTER_PREVIOUS'] = 'После робота';
$MESS['BIZPROC_JS_DEBUGGER_LOG_AFTER_PREVIOUS_MSGVER_1'] = 'После робота:';
$MESS['BIZPROC_JS_DEBUGGER_LOG_TRIGGER_FINISH'] = 'Выполнен';
...
$MESS['BIZPROC_JS_DEBUGGER_NO_ROBOTS_SUBTITLE'] = 'Роботы помогают менеджерам выполнять любые рутинные задачи - сами отправляют рассылки, ставят задачи, планируют встречи, заполняют документы';
$MESS['BIZPROC_JS_DEBUGGER_NO_TRIGGERS_TITLE'] = 'На этой стадии нет триггеров';
$MESS['BIZPROC_JS_DEBUGGER_NO_TRIGGERS_SUBTITLE'] = 'Триггеры отслеживают изменения и автоматически двигают элемент по стадиям';
$MESS['BIZPROC_JS_DEBUGGER_NO_FIELD_TITLE'] = 'Выберите поля, значения которых хотите отслеживать в процессе отладки';
$MESS['BIZPROC_JS_DEBUGGER_NO_FIXED_DOCUMENT'] = 'Выберите сделку, чтобы начать отладку';
$MESS['BIZPROC_JS_DEBUGGER_AUTOMATION_SETTINGS'] = 'Настроить';
...
$MESS['BIZPROC_JS_DEBUGGER_FILTER_TOUR_TEXT_LINE_1_MSGVER_1'] = 'Сейчас активен фильтр [b]Сделки в отладке[/b]. Здесь отображаются ваши сделки для отладки роботов';
